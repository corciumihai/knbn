        ...
        return(
            <div class="container-fluid mt-3 px-0">
                <div class="col-xl-12 col-12 d-flex">
                    <h3 class="knbn-header-3 w-100">Component Editor</h3>
                </div>
                <div class="col-xl-12 col-12 d-flex flex-xl-row flex-column">
                    <EditForm classes="col-xl-4 col-12 px-0">
                        ...
                        <EditField 
                            value={this.state.data.wip}
                            save={this.saveWIP}
                            after='tickets at a time'
                            filler="Work limit not set yet"
                            label='Work limit' 
                            description='Limit for maximum tickets an user can have in progress at once'/>
                    </EditForm>
