...
const RemoveItem = (props) => {
    return(
        <div class={"knbn-remover flex-row knbn-input knbn-editing-mode knbn-bg-transparent pr-0 col px-0" + (props.themeToggled ? " knbn-dark-bg-remover knbn-dark-border-2x knbn-dark-color-5x knbn-dark-onselect" : " knbn-snow-bg-remover")}>
