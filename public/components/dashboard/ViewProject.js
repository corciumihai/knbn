...
class ViewProject extends React.Component{
    ...
    render(){
        return(
            <div class={"knbn-view-project col-xl-12 py-2 mb-2 d-flex flex-column" + (this.props.themeToggled ? " knbn-dark-bg-2x" : "")}>
                ...
                <div class={"col-xl-12 knbn-border-top" + (this.state.showComp ? "" : " hide") + (this.props.themeToggled ? " knbn-dark-border-2x" : "")}>
