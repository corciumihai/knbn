        ...
        return(
            <div class="col ticket-data modifiable py-1">
                <div class="row" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    { this.props.discipline != undefined && this.props.discipline.name.length > 0 ? <div class="edit-field ml-1" title="Category"><img src="/images/category.svg" class="d-block mx-auto"/></div> : null }
                    <div class="col text-truncate"> {this.props.discipline != undefined && this.props.discipline.name.length > 0 ? this.props.discipline.name : "Select category" }</div>
                ...
                <div class="dropdown-menu tag w-100 modifiable">
                {
                    this.state.disciplines.length > 0 ?
                        this.state.disciplines.map(discipline => {
                            let bound = this.setCat.bind(this, discipline);
