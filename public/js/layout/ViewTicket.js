...
import CommentArea from './components/view/CommentArea';
import WorkLogArea from './components/view/WorkLogArea';
        ...
        return (
            ...
            !this.state.loading ?
                <div class="view-ticket col-xl-6 offset-xl-3">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="row my-1">
                                                    ...
                                                    {!this.state.editBlocking ?
                                                        ...
                                                        :
                                                        <OtherTicket ticket={this.state.blocking} set={this.setBlocking}/>
                                                    }
                                                    </div>
                                                    {
                                            ...
                                            <div class="col-xl-6">
                                                <div class="row my-1">
                                                    ...
                                                    {!this.state.editBlockedBy ?
                                                        ...
                                                        :
                                                        <OtherTicket ticket={this.state.blockedBy} set={this.setBlockedBy}/>
                                                    }
                                                    </div>
                                                    {
                                        ...
                                        <div class="row my-1">
                                            ...
                                            <div class="col ticket-data modifiable py-1">
                                                <div class="row">
                                                    ...
                                                    <div class="col text-truncate">{this.state.release.name}</div>
                                                    {
                                        ...
                                        <div class="row my-1">
                                            ...
                                            <div class="col ticket-data modifiable py-1">
                                                <div class="row">
                                                    ...
                                                    <div class="col text-truncate">{this.state.discipline.name}</div>
                                                    {
                    ...
                    <div class="row mb-3">
                        <div class="col mb-2">
                            <ul class="nav nav-tabs bottom-nav tag">
                                <li class="nav-item">
                                    <a class={this.state.commentArea ? "nav-link header px-2 py-2 active" : "nav-link header px-2 py-2"} href="#" onClick={this.switchCommentArea}>Comments</a>
                                </li>
                                <li class="nav-item">
                                    <a class={this.state.commentArea ? "nav-link header px-2 py-2" : "nav-link header px-2 py-2 active"} href="#" onClick={this.switchCommentArea}>Worklog</a>
                                </li>
                            </ul>
                        </div>
                        {
