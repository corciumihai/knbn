                ...
                <div class="col-xl-12 comment mb-3">
                    <div class="row">
                        <div class="col user-text">
                            <div class="row">
                                <div class="col py-1 align-self-center"><span class="info">You</span> logged <span class="info">{this.props.data.hours}</span> hours on {dateformat(this.props.data.created, 'dd.mm.yyyy')}</div>
                                {
